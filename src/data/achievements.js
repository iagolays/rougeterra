...
export const ACHIEVEMENTS = [
  ...
  { id: "el_fin",       name: "¿El fin?",        emoji: "🌌", imageUrl: "/assets/achievements/master.png", desc: "Llega al Vacío.", check: c => c.regionIdx >= 5 },
  ...
  { id: "cain",         name: "Cain",            emoji: "🪙", imageUrl: "/assets/ui/coin.png", desc: "Consigue 25.000 de oro en una sola partida (sin contar el banco).", check: c => c.runGoldEarned >= 25000 },
